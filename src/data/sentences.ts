...
//
// 데이터 규칙:
//   - parts[i] ↔ englishParts[i] 가 의미상 평행 매핑 (한국어 어순 기준)
//   - distractors[i] ↔ englishDistractors[i] 도 평행 매핑 (오답 타일 클릭 시 음성 출력에 사용)
export const SENTENCES: SentenceItem[] = [
  ...
  { id: 'go-home',       english: 'Go home.',            korean: '집에 가요',              parts: ['집에', '가요'],                englishParts: ['home', 'go'],               distractors: ['와요', '달려요'],               englishDistractors: ['come', 'run'] },
  ...
  { id: 'i-like-blue',   english: 'I like blue.',        korean: '나는 파란색이 좋아요',   parts: ['나는', '파란색이', '좋아요'],  englishParts: ['I am', 'blue', 'like'],     distractors: ['빨간색이', '초록색이'],         englishDistractors: ['red', 'green'],  category: 'color' },
  { id: 'i-like-red',    english: 'I like red.',         korean: '나는 빨간색이 좋아요',   parts: ['나는', '빨간색이', '좋아요'],  englishParts: ['I am', 'red', 'like'],      distractors: ['파란색이', '초록색이'],         englishDistractors: ['blue', 'green'], category: 'color' },

  // ── 동물 (animal) ─────────────────────────────────────────────────────
  { id: 'i-like-cats',   english: 'I like cats.',        korean: '나는 고양이가 좋아요',   parts: ['나는', '고양이가', '좋아요'],  englishParts: ['I am', 'cats', 'like'],     distractors: ['개가', '새가'],                 englishDistractors: ['dogs', 'birds'], category: 'animal' },
  ...
  { id: 'i-see-bird',    english: 'I see a bird.',       korean: '새가 보여요',            parts: ['새가', '보여요'],              englishParts: ['bird', 'see'],              distractors: ['들려요', '날아요'],             englishDistractors: ['hear', 'fly'],   category: 'animal' },

  // ── 음식 (food) ───────────────────────────────────────────────────────
  { id: 'i-like-milk',   english: 'I like milk.',        korean: '나는 우유가 좋아요',     parts: ['나는', '우유가', '좋아요'],    englishParts: ['I am', 'milk', 'like'],     distractors: ['빵이', '물이'],                 englishDistractors: ['bread', 'water'], category: 'food' },
  ...
  { id: 'i-want-bread',  english: 'I want bread.',       korean: '빵을 원해요',            parts: ['빵을', '원해요'],              englishParts: ['bread', 'want'],            distractors: ['먹어요', '좋아요'],             englishDistractors: ['eat', 'like'],  category: 'food' },
  ...
  // ── 날씨 (weather) ────────────────────────────────────────────────────
  { id: 'its-sunny',    english: "It's sunny today.",   korean: '오늘은 맑아요',           parts: ['오늘은', '맑아요'],            englishParts: ['today', 'sunny'],           distractors: ['흐려요', '추워요'],             englishDistractors: ['cloudy', 'cold'], category: 'weather' },
  { id: 'its-raining',  english: "It's raining.",       korean: '오늘 비가 와요',          parts: ['오늘', '비가 와요'],           englishParts: ['today', 'is raining'],      distractors: ['맑아요', '눈이 와요'],          englishDistractors: ['sunny', 'is snowing'], category: 'weather' },
  { id: 'its-windy',    english: "It's very windy.",    korean: '바람이 많이 불어요',       parts: ['바람이 많이', '불어요'],       englishParts: ['very windy', 'blows'],      distractors: ['내려요', '쏟아져요'],           englishDistractors: ['falls', 'pours'], category: 'weather' },
  ...
  // ── 교통 (transport) ──────────────────────────────────────────────────
  { id: 'take-the-bus', english: 'I go by bus.',        korean: '버스를 타고 가요',         parts: ['버스를', '타고', '가요'],      englishParts: ['bus', 'by', 'go'],          distractors: ['걸어서', '뛰어서'],             englishDistractors: ['walking', 'running'], category: 'transport' },
  { id: 'take-subway',  english: 'Take the subway.',    korean: '지하철을 타요',            parts: ['지하철을', '타요'],            englishParts: ['subway', 'Take'],           distractors: ['이용해요', '내려요'],           englishDistractors: ['Use', 'Get off'], category: 'transport' },
  { id: 'train-is-fast',english: 'The train is fast.',  korean: '기차는 빨라요',            parts: ['기차는', '빨라요'],            englishParts: ['train', 'fast'],            distractors: ['느려요', '좋아요'],             englishDistractors: ['slow', 'good'],   category: 'transport' },
  ...
  { id: 'see-doctor',   english: 'See a doctor.',       korean: '의사를 만나요',            parts: ['의사를', '만나요'],            englishParts: ['doctor', 'See'],            distractors: ['불러요', '찾아요'],             englishDistractors: ['Call', 'Find'], category: 'health' },
  { id: 'take-medicine',english: 'Take your medicine.', korean: '약을 먹어요',              parts: ['약을', '먹어요'],              englishParts: ['medicine', 'Take'],         distractors: ['사요', '버려요'],               englishDistractors: ['Buy', 'Throw'], category: 'health' },
]
