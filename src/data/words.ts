...
export const WORDS: WordItem[] = [
  ...
  { id: 'head', word: 'head', meaning: '머리', emoji: '🧠', category: 'body' },
  ...
  { id: 'park', word: 'park', meaning: '공원', emoji: '🏞️', category: 'place' },
  { id: 'shop', word: 'shop', meaning: '가게', emoji: '🏪', category: 'place' },
  { id: 'hospital', word: 'hospital', meaning: '병원', emoji: '🏥', category: 'place' },
  { id: 'library', word: 'library', meaning: '도서관', emoji: '🏛️', category: 'place' },
  // 가족 (8) ← 신규
